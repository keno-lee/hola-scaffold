 ...
 */
const updateHolaConfigs = (addCode: object): void => {
 ...
 */
function getObjectAst(obj: object): object {
  let properties = [] as object[];
 ...
 */
function getPropertyAst(propertyKey: string, propertyValue: string): object {
...
export default updateHolaConfigs;
